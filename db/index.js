...
async function adminGetCompanyDocument(id){
  const c=(await query('SELECT documento_empresa FROM companies WHERE id=$1',[id]))[0];
  if(!c) return null;
